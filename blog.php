            ...
            <li class="nav-item px-4">
              <div class="dropdown">
                  ...
                  <div class="dropdown-content">
                    <a href="blog-fr.php" id="Fr" style="font-size: 11px;text-transform: uppercase;font-weight: 600!important;letter-spacing: 0.1em;text-decoration: none;"><img src="images/fr.png" style="height: 20px;width: 20px;margin-right: 10px !important;">FR</a>
                    <a href="blog.php" id="Eng" style="font-size: 11px;text-transform: uppercase;font-weight: 600!important;letter-spacing: 0.1em;text-decoration: none;"><img src="images/eng.png" style="height: 20px;width: 20px;margin-right: 10px !important;">EN</a>
                  </div>
              </div>
          </li>
          </ul>
  ...
  <div class="banner">
    ...
    <div class="container">
        ...
        <div class="banner-title">
            <h1><img  class="img-responsive" src="images/logo.png" alt="">  Blog</h1>
            <p style="font-family: Romans;">Here our blogs</p>
...
<div class = "design" id = "design">
    ...
    <div class = "container">
      <div class = "title">
        <h2>Search about your Blogs</h2>
        <p>You can find any informations about SIPSEV here </p>
      </div>
...
<div class="container col-6 mt-5">
  ...
  <div style="background-color: #f9f9f9;border-radius: 15px;" class="row row-cols-1 row-cols-md-2 g-4">
     <div class="col">
    <div class="card">
      <div class="card-img">
        <img  src="images/G1_n.jpg" class="card-img-top" alt="Fissure in Sandstone"/>
          <div class="card-body">
        <h4>Blog 1 </h4>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit.
         Nulla odit eius praesentium repellendus. Consequuntur,
        tempora libero. Asperiores alias tempora eius vitae minus, officia 
        veritatis suscipit rerum commodi cupiditate magnam odit.
        <span class="moree">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit.
           Debitis explicabo laboriosam vel incidunt? Optio harum 
           voluptatum est at, impedit, eaque nihil, maiores 
          praesentium voluptate debitis atque dicta iste totam quas!
        </span>
    ...
    <div class="col">
        <div class="card">
          <div class="card-img">
            <img  src="images/G2_n.jpg" class="card-img-top" alt="Fissure in Sandstone"/>
              <div class="card-body">
              <h4>Blog 2</h4>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit.
             Nulla odit eius praesentium repellendus. Consequuntur,
    ...
    <div class="col">
      <div class="card">
        <div class="card-img">
          <img  src="https://www.planete-energies.com/sites/default/files/styles/media_full_width_940px/public/thumbnails/image/41885_1240x800_0.jpg?itok=NszKW-hg" class="card-img-top" alt="Fissure in Sandstone"/>
            <div class="card-body">
          <h4>Blog 3</h4>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit.
           Nulla odit eius praesentium repellendus. Consequuntur,
     ...
     <div class="col">
      <div class="card">
        <div class="card-img">
          <img  src="images/G4_n.jpg" class="card-img-top" alt="Fissure in Sandstone"/>
            <div class="card-body">
          <h4>Blog 4</h4>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit.
           Nulla odit eius praesentium repellendus. Consequuntur,
     ...
     <div class="col">
      <div class="card">
        <div class="card-img">
          <img  src="images/G5_n.jpg" class="card-img-top" alt="Fissure in Sandstone"/>
            <div class="card-body">
          <h4>Blog 5</h4>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit.
           Nulla odit eius praesentium repellendus. Consequuntur,
     ...
     <div class="col">
      <div class="card">
        <div class="card-img">
          <img  src="images/G6_n.jpg" class="card-img-top" alt="Fissure in Sandstone"/>
            <div class="card-body">
          <h4>Blog 6</h4>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit.
           Nulla odit eius praesentium repellendus. Consequuntur,
    ...
    <div class="card">
      <div class="card-img">
        <img  src="https://www.levert.ma/wp-content/uploads/2019/06/pompage-solaire-agadir-2019-678x381.png" class="card-img-top" alt="Fissure in Sandstone"/>
          <div class="card-body">
        <h4>Blog 9 </h4>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit.
         Nulla odit eius praesentium repellendus. Consequuntur,
       ...
       <div class="col">
        <div class="card">
          <div class="card-img">
            <img  src="https://www.alfilaha.com/wpalfilaha/wp-content/uploads/2013/09/irrigationsolar.jpg" class="card-img-top" alt="Fissure in Sandstone"/>
              <div class="card-body">
              <h4>Blog 10</h4>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit.
             Nulla odit eius praesentium repellendus. Consequuntur,
      ...
      <div class="row  text-md-left">
          <div class="footer-col col-md ">
              <ul>
                  ...
                  <li>
                      <p>Salon National de l'e-Commercee <br> Copyright @ 2022. All rights reserved.</p>
                  </li>
              </ul>
          </div>
          <div class="footer-col col-md">
